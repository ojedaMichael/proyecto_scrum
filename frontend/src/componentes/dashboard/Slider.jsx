  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-[#111827] dark:bg-gray-800">
          <img src="./src/assets/react.svg" alt="" />
          <ul className="space-y-2 font-medium border-t "></ul>
          <h1 className="text-white font-extrabold leading-none tracking-tigh md:text-xl lg:text-2xl dark:text-white">Jean Pierre Ramos</h1>

          <p className="text-center flex items-center  text-white dark:text-gray-400">
            Administrador
          </p>
          <span className="text-center text-white dark:text-gray-400">
            Admin@admin
          </span>
